...
<body>
	<div class="main">
		<div>
		    <h3 align="center">添加新闻(view)</h3>
		    
		    <form method="post" action="/lvnong/lvnong_item/lvnong/Admin/Content/addnews" class="form-horizontal" role="form">
				<label>标题</label><input type="text" name="title" id="title" class="form-control" style="width:200px;">
			    ...
			    <input type="submit" name="submit" value="新增" id="su">
		    </form>
		</div>
<!-- 		<div>
    <div>
