...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/lvnong/lvnong_item/lvnong/Public/UEditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/lvnong/lvnong_item/lvnong/Public/UEditor/ueditor.all.min.js"> </script>
...
<body>
	<div class="righter">
		<div>
		    <h3 align="center">修改新闻动态(view)</h3>
		    
		    <form method="post" action="/lvnong/lvnong_item/lvnong/Admin/Content/updata" class="form-horizontal" role="form">
				<label>标题</label><input type="text" name="title" id="title" value="<?php echo ($list["title"]); ?>" class="form-control" style="width:200px;">
				<input type="hidden" value="<?php echo ($list["id"]); ?>" name="contentid" id="contentid">
				<textarea name="myEditor" id="myEditor"><?php echo ($list["content"]); ?></textarea>
			    ...
			    <input type="submit" name="submit" value="修改新闻" id="su">
		    </form>
		</div>
<!-- 		<div>
    <div>
