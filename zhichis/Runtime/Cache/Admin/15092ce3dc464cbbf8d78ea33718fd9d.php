...
<head>
	...
	<style type="text/css">
		...
		body {
			width: 1520px;
			height: 868px;
			background:url(/lvnong/lvnong_item/lvnong/Public/img/banner.jpg) top center no-repeat; 
...
<body>
	<div class="loginBox">
		<form method="POST" action="/lvnong/lvnong_item/lvnong/Admin/Admin/login" class="form-signin" role="form">
			...
			<span><a href="/lvnong/lvnong_item/lvnong/Admin/Manager/insmanager">注册管理员</a></span>
