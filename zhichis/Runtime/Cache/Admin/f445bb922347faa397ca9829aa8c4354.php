...
<body>
	<div class="main">
		<h3 align="center">新闻列表(view)</h3>
		<table class="table table-bordered table-striped">
            <tr>
                <td colspan="3" bgcolor="#FFFFFF" class="title" align="center">当前登录用户：<?php echo session('nickname');?></td>
            </tr>
            <tr>
                <td colspan="3" bgcolor="#FFFFFF" class="title" align="center">新闻动态</td>
            </tr>
            <tr class="title active">
                <td bgcolor="#FFFFFF" width="100">新闻编号</td>
                <td bgcolor="#FFFFFF" width="100">新闻标题</td>
                <td bgcolor="#FFFFFF" width="60">新闻主题</td>
            ...
            <?php if(is_array($select)): foreach($select as $key=>$list): ?><tr class="content" align="center">
                        ...
                        <td bgcolor="#FFFFFF" id="oper">&nbsp;
                            <a href="/lvnong/lvnong_item/lvnong/Admin/Content/savenews/id/<?php echo ($list["id"]); ?>" target="center">编辑</a>&nbsp;
                            <a href="javascript:frame('/lvnong/lvnong_item/lvnong/Admin/Content/delContent/id/<?php echo ($list["id"]); ?>')" target="center">删除</a>
                        </td>
