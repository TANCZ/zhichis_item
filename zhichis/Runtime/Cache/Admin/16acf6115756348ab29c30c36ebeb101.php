...
<body>
	<div class="left">
		<div class="div1">
			...
			<div class="div3">
			    <ul>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/Manager/sqlmanager" target="center"><li> 管理员信息</li></a>
			        <a href="<?php echo ADMIN_MANAGER?>upmanager" target="center"><li> 修改信息</li></a>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/Manager/uppassword" target="center"><li> 修改密码</li></a>
			    </ul>
			</div>
		    ...
		    <div class="div3">
		      	<ul>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/User/userlist" target="center"><li> 客户列表</li></a>
		        </ul>
		    </div>
		    ...
		    <div class="div3">
		      	<ul>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/pro/listpro" target="center"><li> 商品列表</li></a>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/pro/add" target="center"><li> 新增商品</li></a>
		        </ul>
		    </div>
		    ...
		    <div class="div3">
		      	<ul>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/order/orderlist" target="center"><li> 订单列表</li></a>
		        </ul>
		    </div>
		    ...
		    <div class="div3">
		      	<ul>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/content/essaylist" target="center"><li> 文章列表</li></a>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/content/addessay" target="center"><li> 新增文章</li></a>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/content/newslist" target="center"><li> 新闻列表</li></a>
			        <a href="/lvnong/lvnong_item/lvnong/Admin/content/addnews" target="center"><li> 新增新闻</li></a>
		        </ul>
		    </div>
		    ...
		    <div class="div3">
		      	<ul>
			        ...
			        <a href="/lvnong/lvnong_item/lvnong/Admin/qrcode/setqrcode" target="center"><li> 二维码</li></a>
		        </ul>
		    </div>
