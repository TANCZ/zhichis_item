...
<div class="banner">
    <div class='swipe'>
        <ul id='slider'>
            <li style='display:block'><img src="/lvnong_item/lvnong/Public/img/banner_yg.jpg" alt="轮播图一" /></li>
...
<div class="container2">
    <div class="content">
        ...
        <div class="choose-list">
            <input type="radio" name="choose" id="rad1" checked/><label class="lab1" for="rad1">500g</label>
        </div>
    </div>
</div>
...
<div class="container4">
    <div class="content">
        ...
        <img class="page-img" src="/lvnong_item/lvnong/Public/img/yugao-page.jpg" alt=""/>
    </div>
</div>
