...
<head>
    ...
    <title>舌尖上的螃蟹</title>
    <link rel="stylesheet" type="text/css" href="/lvnong_item/lvnong/Public/css/base_page.css">
...
<div class="banner">
    <div class='swipe'>
        <ul id='slider'>
            <li style='display:block'><img src="/lvnong_item/lvnong/Public/img/banner_px.jpg" alt="轮播图一" /></li>
            <li><img src="/lvnong_item/lvnong/Public/img/banner_px.jpg" alt="轮播图二" /></li>
        </ul>
...
<div class="container2">
    <div class="content">
        ...
        <div class="choose-list">
            <input type="radio" name="choose" id="rad1" checked/><label class="lab1" for="rad1">1.5两10个</label>
            <input type="radio" name="choose" id="rad2"/><label class="lab2" for="rad2">1.9两13个</label>
        </div>
    </div>
</div>
...
<div class="container4">
    <div class="content">
        ...
        <a href="/lvnong_item/lvnong/HOME/Index/index.html"><div class="gotoIndex">返回首页</div></a>
        <img class="page-img" src="/lvnong_item/lvnong/Public/img/pangxie-page.jpg" alt=""/>
    </div>
</div>
