...
<div class="banner">
    <div class='swipe'>
        <ul id='slider'>
            <li style='display:block'><img src="/lvnong_item/lvnong/Public/img/banner_yd.jpg" alt="轮播图一" /></li>
...
<div class="container1">
    <div class="content">
        <div class="container1-text">
            <p class="p1">知吃氏 -  石首笔架鱼肚</p>
            <p class="p2 fs" id="newPric">促销价：<span>￥138.00</span></p>
            <p class="p2 ls" id="oldPric">原价：<s>￥158.00</s></p>
...
<div class="container2">
    <div class="content">
        ...
        <div class="choose-list">
            <input type="radio" name="choose" id="rad1" checked/><label class="lab1" for="rad1">128g</label>
            <input type="radio" name="choose" id="rad2"/><label class="lab2" for="rad2">320g</label>
        </div>
    </div>
</div>
...
<div class="container4">
    <div class="content">
        ...
        <img class="page-img" src="/lvnong_item/lvnong/Public/img/yudu-page.jpg" alt=""/>
    </div>
</div>
