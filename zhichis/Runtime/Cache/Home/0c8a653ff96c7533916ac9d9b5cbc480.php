...
<div class="banner">
    <div class='swipe'>
        <ul id='slider'>
            <li style='display:block'><img src="/lvnong_item/lvnong/Public/img/banner_ht.jpg" alt="轮播图一" /></li>
...
<div class="container4">
    <div class="content">
        ...
        <img class="page-img" src="/lvnong_item/lvnong/Public/img/huangtao-page.jpg" alt=""/>
    </div>
</div>
